    ...
    <>
      {products && categories === 'pending' ? (
        ...
        <div className='text-roboto my-16 mx-auto w-[1300px] px-8 text-lg sg:w-[1020px] md:w-[760px] sm:w-[480px] xs:w-[399px] xs:px-0'>
          <div className='mb-6 flex w-full items-center justify-between border-b border-main/[0.2] pb-2 sm:grid sm:w-[480px] sm:justify-start sm:space-y-4 xs:w-[400px]'>
            <h2 className='text-3xl font-bold md:hidden'>Товары</h2>
            <Search search={search} onHandleSearch={setSearch} />
            <Sorting sortType={sortType} onSortType={handleSortType} />
          </div>
          <div className=' flex space-x-10 md:grid md:gap-4'>
            ...
            <div className='mx-auto grid w-3/4 grid-cols-4 gap-8 sg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1'>
              {sortingProducts ? (
